...
/*
    Kangaroo Unit Nominal Conversion Values. Sending these values to each respective wheel results in about 60 RPM +/- .5. May need to adjust when tuning the robot on the ground(?)...Conversion to KU units is #KU_CONSTANT/CONV_VAL and vice versa.
*/
